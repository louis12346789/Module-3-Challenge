...
PyBankcsv = os.path.join(r"Documents/Github/python-challenge/PyBank/Resources/budget_data.csv")
...
with open("Documents/Github/python-challenge/financial_analysis.txt", 'w') as file:
    file.write("----------------------------------------------------------\n")
